...
$inssql="Create table ".$target_file." (";
	...
	$txt="Insert into ".$_POST['tableinputname']." (";
		...
		echo "<div class='container'><table style=' display: block;
  height: 80%;
 ...
 echo "<div class='row'>"; }
	...
	echo "<div class='input-field col s6'><input id='".$r."' type='text' class='validate' name='".$r."'><label for='".$r."'>".$r."</label></div>"; 
	 $row++;
 }
